...
function App() {
  ...
  return (
    <>
      ...
      <main>
      <div className="about">
  <p>Bem-vindo ao Pandaflix! Somos uma base de dados online que reúne informações sobre filmes de diversos gêneros. Servindo como uma espécie de enciclopédia virtual, nós disponibilizamos. Se você é um fã de entretenimento em busca de uma gama diversificada de perspectivas com curadoria em um formato fácil de entender, nós o ajudaremos a encontrar o que você está a fim e abrir seus olhos para novas coisas para aproveitar.
  </p>
</div>
